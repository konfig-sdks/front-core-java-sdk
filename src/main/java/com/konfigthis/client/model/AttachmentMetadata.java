 ...
 * Attachment metadata
 */
@ApiModel(description = "Attachment metadata")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AttachmentMetadata {
  ...
  public AttachmentMetadata isInline(Boolean isInline) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "Whether or not the attachment is part of the message body")
  ...
  public AttachmentMetadata cid(String cid) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "526b45586d0e6b1c484afab63d1ef0be", value = "Unique identifier used to link an attachment to where it is used in the message body")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isInline, attachmentMetadata.isInline) &&
        Objects.equals(this.cid, attachmentMetadata.cid)&&
        Objects.equals(this.additionalProperties, attachmentMetadata.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isInline, cid, additionalProperties);
  }
