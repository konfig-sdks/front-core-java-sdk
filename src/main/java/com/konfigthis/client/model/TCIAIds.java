...
public class TCIAIds {
  ...
  public TCIAIds tagIds(List<String> tagIds) {
  ...
  public TCIAIds addTagIdsItem(String tagIdsItem) {
    if (this.tagIds == null) {
  ...
  **/
  ...
  public TCIAIds teammateIds(List<String> teammateIds) {
  ...
  public TCIAIds addTeammateIdsItem(String teammateIdsItem) {
  ...
  **/
  ...
  public TCIAIds channelIds(List<String> channelIds) {
  ...
  public TCIAIds addChannelIdsItem(String channelIdsItem) {
  ...
  **/
  ...
  public TCIAIds inboxIds(List<String> inboxIds) {
  ...
  public TCIAIds addInboxIdsItem(String inboxIdsItem) {
  ...
  **/
  ...
  public TCIAIds teamIds(List<String> teamIds) {
  ...
  public TCIAIds addTeamIdsItem(String teamIdsItem) {
  ...
  **/
  ...
  public TCIAIds accountIds(List<String> accountIds) {
  ...
  public TCIAIds addAccountIdsItem(String accountIdsItem) {
  ...
  **/
   ...
   * @return the TCIAIds instance itself
   */
  public TCIAIds putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TCIAIds tcIAIds = (TCIAIds) o;
    return Objects.equals(this.tagIds, tcIAIds.tagIds) &&
        Objects.equals(this.teammateIds, tcIAIds.teammateIds) &&
        Objects.equals(this.channelIds, tcIAIds.channelIds) &&
        Objects.equals(this.inboxIds, tcIAIds.inboxIds) &&
        Objects.equals(this.teamIds, tcIAIds.teamIds) &&
        Objects.equals(this.accountIds, tcIAIds.accountIds)&&
        Objects.equals(this.additionalProperties, tcIAIds.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TCIAIds
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TCIAIds.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TCIAIds is not found in the empty JSON string", TCIAIds.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TCIAIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TCIAIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TCIAIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TCIAIds.class));

       return (TypeAdapter<T>) new TypeAdapter<TCIAIds>() {
           @Override
           public void write(JsonWriter out, TCIAIds value) throws IOException {
           ...
           @Override
           public TCIAIds read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TCIAIds instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TCIAIds given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TCIAIds
  * @throws IOException if the JSON string is invalid with respect to TCIAIds
  */
  public static TCIAIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TCIAIds.class);
  }

 /**
  * Convert an instance of TCIAIds to an JSON string
  *
  * @return JSON string
  */
