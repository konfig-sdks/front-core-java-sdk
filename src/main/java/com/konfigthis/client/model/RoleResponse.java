...
import com.konfigthis.client.model.RoleResponseLinks;
...
public class RoleResponse {
  ...
  private RoleResponseLinks links;
  ...
  public RoleResponse links(RoleResponseLinks links) {
  ...
  **/
  ...
  public RoleResponseLinks getLinks() {
    return links;
  }


  public void setLinks(RoleResponseLinks links) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "from", value = "Name of the role")
   ...
   * @return the RoleResponse instance itself
   */
  public RoleResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, roleResponse.links) &&
        Objects.equals(this.id, roleResponse.id) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("_links") != null && !jsonObj.get("_links").isJsonNull()) {
        RoleResponseLinks.validateJsonObject(jsonObj.getAsJsonObject("_links"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RoleResponse>() {
           ...
           public RoleResponse read(JsonReader in) throws IOException {
             ...
             RoleResponse instance = thisAdapter.fromJsonTree(jsonObj);
