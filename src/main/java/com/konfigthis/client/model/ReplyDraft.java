...
public class ReplyDraft {
 ...
 public enum ModeEnum {
  ...
  public ReplyDraft authorId(String authorId) {
  ...
  **/
  ...
  public ReplyDraft to(List<String> to) {
  ...
  public ReplyDraft addToItem(String toItem) {
    if (this.to == null) {
  ...
  **/
  ...
  public ReplyDraft cc(List<String> cc) {
  ...
  public ReplyDraft addCcItem(String ccItem) {
    if (this.cc == null) {
  ...
  **/
  ...
  public ReplyDraft bcc(List<String> bcc) {
  ...
  public ReplyDraft addBccItem(String bccItem) {
    if (this.bcc == null) {
  ...
  **/
  ...
  public ReplyDraft subject(String subject) {
  ...
  **/
  ...
  public ReplyDraft body(String body) {
  ...
  **/
  ...
  public ReplyDraft quoteBody(String quoteBody) {
  ...
  **/
  ...
  public ReplyDraft attachments(List<File> attachments) {
  ...
  public ReplyDraft addAttachmentsItem(File attachmentsItem) {
  ...
  **/
  ...
  public ReplyDraft mode(ModeEnum mode) {
  ...
  **/
  ...
  public ReplyDraft signatureId(String signatureId) {
  ...
  **/
  ...
  public ReplyDraft shouldAddDefaultSignature(Boolean shouldAddDefaultSignature) {
  ...
  **/
  ...
  public ReplyDraft channelId(String channelId) {
  ...
  **/
   ...
   * @return the ReplyDraft instance itself
   */
  public ReplyDraft putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReplyDraft replyDraft = (ReplyDraft) o;
    return Objects.equals(this.authorId, replyDraft.authorId) &&
        Objects.equals(this.to, replyDraft.to) &&
        Objects.equals(this.cc, replyDraft.cc) &&
        Objects.equals(this.bcc, replyDraft.bcc) &&
        Objects.equals(this.subject, replyDraft.subject) &&
        Objects.equals(this.body, replyDraft.body) &&
        Objects.equals(this.quoteBody, replyDraft.quoteBody) &&
        Objects.equals(this.attachments, replyDraft.attachments) &&
        Objects.equals(this.mode, replyDraft.mode) &&
        Objects.equals(this.signatureId, replyDraft.signatureId) &&
        Objects.equals(this.shouldAddDefaultSignature, replyDraft.shouldAddDefaultSignature) &&
        Objects.equals(this.channelId, replyDraft.channelId)&&
        Objects.equals(this.additionalProperties, replyDraft.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorId, to, cc, bcc, subject, body, quoteBody, attachments, mode, signatureId, shouldAddDefaultSignature, channelId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReplyDraft {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReplyDraft
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReplyDraft.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplyDraft is not found in the empty JSON string", ReplyDraft.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReplyDraft.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplyDraft.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplyDraft' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplyDraft> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplyDraft.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplyDraft>() {
           @Override
           public void write(JsonWriter out, ReplyDraft value) throws IOException {
           ...
           @Override
           public ReplyDraft read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReplyDraft instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReplyDraft given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReplyDraft
  * @throws IOException if the JSON string is invalid with respect to ReplyDraft
  */
  public static ReplyDraft fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplyDraft.class);
  }

 /**
  * Convert an instance of ReplyDraft to an JSON string
  *
  * @return JSON string
  */
