...
/**
 * Model tests for UpdateConversation
 */
public class UpdateConversationTest {
    private final UpdateConversation model = new UpdateConversation();
