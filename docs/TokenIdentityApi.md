...
|------------- | ------------- | -------------|
| [**getDetails**](TokenIdentityApi.md#getDetails) | **GET** /me | API Token details |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TokenIdentityApi#getDetails");
